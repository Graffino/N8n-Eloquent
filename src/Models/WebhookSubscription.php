...
class WebhookSubscription extends Model
{
    ...
    public function toLegacyArray(): array
    {
        return [
            ...
            'verify_hmac' => $this->verify_hmac,
            'require_timestamp' => $this->require_timestamp,
            'expected_source_ip' => $this->expected_source_ip,
            'active' => $this->active,
